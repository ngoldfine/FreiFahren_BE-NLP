...
class TestFindStationAndLineFunction(unittest.TestCase):
    def test_find_station_and_line_dynamic_threshold(self):
        ...
        test_cases = [
            ...
            ("Grad ausgestiegen s41", None, None, None),
            ("S7, 2 männlich gelesene in zivil grad Friedrichstraße mit jemandem ausgestiegen", "Friedrichstraße", None, None),
            ...
            ("Controller in S7 Richtung Alexanderplatz Was just checked in jannowitzbrucke", "Jannowitzbrücke", "S7", "Potsdam Hauptbahnhof"),
            ...
            ("U3 freie Universität stehen blau Westen. Sie werden wohl die nächste Bahn in die Innenstadt nehmen", "Freie Universität (Thielplatz)", "U3", None),
