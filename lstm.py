...
data = [
    ("heinrich-heine zwei blauwesten", "Heinrich-Heine-Straße", None, None),
            ...
            ("s-bahn kontrolleure friedrichstrasse 2mal weiblich eine kräftig und blonde haare lang andere dünner grüne jacke", "Friedrichstrasse", None, None),
            ...
            ("zwei bos westen mit gelbem nacken sind gerade schönleinstr u8 richtung hermannstr eingestiegen", "Schoenleinstr", "U8", "Hermannstr"), 
            ("3 bos u8 richtung wittenau, weinmeisterstr ausgestiegen", "Weinmeisterstr", "U8", "Wittenau"), 
            ...
            ("2 Männer mit blauen Westen stiegen in die U8 Richtung Witteneu @ Henrich-Heine-Straße ein", "Heinreich-Heine-Strasse", "U8", "Wittenau"), 
            ...
            ("U6, Paradestraße Richtung Kurt-Schumacher-Platz, BVG zusammen mit Polizei. Mind. zu sechst.", "Paradestrasse", "U6", "Kurt-Schumacher-Platz"), 
            ...
            ("2 blaue Westen U9 Richtung Steglitz \nam u amruner str ausgestiegen", "Amrunerstrasse", "U9", "Steglitz"), 
            ...
            ("Three in civil at invalidenpark entering m10 direction warschauer", "Invalidenpark", "M10", "Warschauerstrasse"), 
            ("U2 nollendorfplatz richtung ruhleben", "Nollendorfplatz", "U2", "Ruhleben"), 
            ("Polizei boddinstrasse", "Boddinstrasse", None, None), 
            ("U5 Alexanderplatz am Gleis richtung HBF 2 Blauwesten", "Alexanderplatz", "U5", "Hauptbahnhof"), 
            ("U6 Seetr. Richtung Alt. Mariendorf : Bullen und BVG Security stressen Obdachlose", "Seestrasse", "U6", "Alt-Mariendorf"),
            ("Ring Neukölln, two man with yellow shirt. S41 right now", "Neukoelln", "S41", None),
            ("Osloer Str U9", "Osloerstrasse", "U9", None),
            ("nuxU5 Alexanderplatz am Gleis richtung HBF 2 BlauwestenUff-Basse !", "Alexanderplatz", "U5", "Hauptbahnhof"),
            ("U7 Wilmersdorfer str richtung Rudow", "Wilmersdorferstrasse", "U7", "Rudow"),
            ("2männer in blau", None, None, None),
            ("Ringbahn S41 jetzt gleich Tempelhof", "Tempelhof", "S41", None),
            ("U8 Richtung hermannstraße Just got out there standing on the platform Bernauer Straße Sind ausgestiegen Bernauer Straße", "Bernauerstrasse", "U8", None),
            ("U7 Wilmersdorfer str richtung rudow standing on the platform, 4 men wearing blue vests", "Wilmersdorferstrasse", "U7", "Rudow"),
            ("Stephen MarcalanRingbahn S41 jetzt gleich TempelhofWie sehen die aus?", None, None, None),
            ("Platz der Luftbruecke", "Platz der Lueftbruecke", None, None)
    # Add more data samples here
    # ("Message","Station", "Line", "Direction" )
    # If any piece of information is missing in a data sample, use None
    # For example, ("Some message", None, "U2", None)
]
